...
# from SuperNet.utils import get_same_padding, min_divisible_value, SEModule, ShuffleLayer
# from SuperNet.utils import MyNetwork, MyModule
# from SuperNet.utils import build_activation, make_divisible

from .common_tools import get_same_padding, min_divisible_value
from .pytorch_modules import SEModule, ShuffleLayer,build_activation, make_divisible
from .my_modules import MyNetwork, MyModule
